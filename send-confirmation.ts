  ...
  ar: {
    ...
    body: (name, plan) => `
      <div dir="rtl" style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#16213A;">
        <p>شكراً  على التسجيل ديالكم فـ المؤتمر المهني الألماني المغربي، وكنشكروا ليكم الثقة والاهتمام بالمشاركة.</p>
        <p>تم التوصل بطلب التسجيل ديالكم، وغادي يتم دراستو ومراجعته من طرف فريقنا. من بعد، غادي نتواصلو معاكم باش نأكدوا الخطوات الموالية ونمدّوكم بجميع المعلومات المتعلقة بإتمام التسجيل والأداء.</p>
        <p>كنتمناو نشوفوكم قريباً فالمؤتمر.</p>
        <p style="margin-top:24px;">مع خالص التحيات،<br><strong>فريق المؤتمر المهني الألماني المغربي</strong></p>
      </div>
    `,
  },
};
